...
The software can generate difficult geometry problem suitable for mathematical contests. The following is a automatically generated, drawn, and stated problem:
<br />
...
* `CircleWithCenterThroughPoint` - takes a circle and outputs its center.
...
Note the following folder, which contains all written MetaPost macros and drawing rules. 
